...
// await connection.query(
//   `
// INSERT INTO temp_h1b_data (case_status, emp_name, job_title, soc_code, soc_name, full_time_position, prevailing_wage, pw_unit, work_state, work_city)
...
for (let i = 2060000; i < 2053652; i += 10000) {
...
for (let i = 1000000; i < 5301382; i += 10000) {
  console.log(`starting ${i}`);
